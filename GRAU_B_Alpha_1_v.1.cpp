...
arqEntrada.open("Teste.txt1.");
    
    cout<<"\n Digite o local (EX: A1): ";
    cin>>ocupante.local;
...
cout<<endl<<"Area do Cinema:\n"<<endl;
                 ...
                 int valor_ocupante1 = (int)ocupante.local[0] - 63;
                cout<<valor_ocupante1;
    ...
    for (cinemaL = 1; cinemaL != contador_linha + 1; cinemaL++) {
        ...
        break;
            ...
            for (cinemaC = 0; cinemaC < contador_coluna; cinemaC++) {
                //cout << cinemaC << "\t" << valor_ocupante;
                if (cinemaC == valor_ocupante2 && cinemaC == valor_ocupante1) { cout<<"\t[ X ]"; }
                else { cout<<"\t[ O ]"; } 
